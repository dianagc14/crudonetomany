     ...
     <div class="table-container">
      <form method="POST" action="{{ route('usuario.update',$usuario->id) }}"  role="form">
       ...
       <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="apellidopaterno id="npagina" class="form-control input-sm" value="{{$usuario->apellidopaterno}}">
         </div>
        </div>
       </div>
       ...
       <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="apellidomaterno" id="apellidomaterno" class="form-control input-sm" value="{{$usuario->apellidomaterno}}">
         </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
